...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/31 14:36:12 by jboumal           #+#    #+#             */
/*   Updated: 2022/01/31 14:36:22 by jboumal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	char		*line;
	static char	stc_line[OPEN_MAX][BUFFER_SIZE];
	int			n;
	...
	*line = '\0';
	...
	{
		n = read_next_line(fd, buffer, stc_line[fd], &line);
	}
	if (!line)
		return (NULL);
	if (*line)
